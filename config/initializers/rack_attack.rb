class Rack::Attack
  ...
  class Request < ::Rack::Request
    ...
    def allowed_ip?
      allowed_ips = ['127.0.0.1', '::1', ENV.fetch('RACK_ATTACK_ALLOWED_IP_1', '127.0.0.1'), ENV.fetch('RACK_ATTACK_ALLOWED_IP_2', '127.0.0.1'), ENV.fetch('RACK_ATTACK_ALLOWED_IP_3', '127.0.0.1'), ENV.fetch('RACK_ATTACK_ALLOWED_IP_4', '127.0.0.1'), ENV.fetch('RACK_ATTACK_ALLOWED_IP_5', '127.0.0.1'), ENV.fetch('RACK_ATTACK_ALLOWED_IP_6', '127.0.0.1')]
